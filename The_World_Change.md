...
Le changement est beaucoup plus profond que la mécanisation classique. La machine ne multiplie plus seulement la productivité de l'homme. Elle peut remplacer certaines étapes de son travail, puis parfois des chaînes entières d'activités.
...
Le problème n'est pas seulement socialiste, capitaliste ou idéologique. C'est un problème de cohérence.
...
Une entreprise possède une histoire. Une activité possède également une structure économique. On peut observer la part du chiffre d'affaires qui était autrefois consacrée au travail humain et la comparer à la part qui reste nécessaire lorsque l'automatisation se développe.
...
C'est cette transformation qui peut servir de base à une contribution liée à la machine.
