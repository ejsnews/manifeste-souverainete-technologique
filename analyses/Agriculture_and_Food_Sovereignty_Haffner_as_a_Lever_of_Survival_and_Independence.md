...
- Average income below €600 per month for half of all farmers
- Insurmountable structural debt (equipment, land, inputs)
- Total dependence on imported nitrogen fertilizers (derived from Russian or American natural gas)
- Dependence on fossil fuel prices for agricultural machinery
...
### What a Haffner Module Produces from Agricultural Waste
| Input (Agricultural Waste) | Product | Local Use |
|:---------------------------|:--------|:----------|
| Cereal straw | Syngas → energy | Grain drying, greenhouse heating |
| Pruning residues (vineyards, orchards) | Syngas → electricity | Powering the farm |
...
The hydrogen produced by a Haffner module directly powers:
- Hydrogen fuel cell tractors and agricultural equipment
- Utility vehicles on the farm
- Backup generators
...
The syngas produced by thermolysis contains hydrogen (H₂). This hydrogen, combined with nitrogen from ambient air via the **Haber-Bosch process**, produces ammonia (NH₃) — the base molecule for all nitrogen fertilizers.
...
- Improved water retention (+20 to 40%)
- Fixation and slow release of nutrients
- Reduced need for pesticides (adsorption of residues)
- Carbon sequestration in soils for centuries
...
**Typical Scenario: Cooperative of 20 Farms**
- Each farm contributes its biomass residues
- The cooperative operates 2 to 3 Haffner modules on a central site
- Shared production: energy, hydrogen, ammonia, biochar
...
| Revenue Source | Mechanism | Order of Magnitude |
|:---------------|:-----------|:-------------------|
| Local hydrogen sales | Nearby H₂ stations | €6-8/kg sold |
| Electricity sales | Grid or collective self-consumption | Market price |
| Biochar carbon credits | Voluntary markets (CORC) | €110-140/t CO₂ |
| Ammonia/fertilizer sales | Neighboring cooperatives | Market price -30% |
...
- Depend on Russian or American gas for their fertilizers
- Depend on oil for their machinery
- Close their farms due to insufficient income
- Face unfair competition from imports produced without our standards

Haffner Energy gives farmers the means for their autonomy: **self-produced energy, self-produced fertilizers, additional revenues, regenerated soils.** It is the necessary condition — previously missing — for true French food sovereignty.

**What the State must do:**
1. **Authorize and exempt** the production of self-produced agricultural fuel from residual biomass
