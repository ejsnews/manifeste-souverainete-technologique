# HAFFNER ENERGY: FRANCE IS LETTING ITS ENERGY REVOLUTION GO ABROAD [(French version - FR)](HAFFNER_ENERGY_LA_FRANCE_LAISSE_PARTIR_SA_RÉVOLUTION_ÉNERGÉTIQUE_À_L_ÉTRANGER.md)
...
- **Competitive clean energy production**: green hydrogen, SAF, biomethane, methanol — at costs close to or below fossil fuels, starting with the H6 module already available today
- **Active carbon sequestration**: 200 kg of biochar per tonne of biomass processed, a solid and stable carbon sink for centuries, monetizable as CORC credits on European markets
- **Territorial sovereignty**: containerized module, no foundations, operational in less than one month, using 140 types of residual biomass — from wheat straw to urban waste
