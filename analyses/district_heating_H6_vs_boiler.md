...
- **Water retention:** the highly porous structure of biochar (specific surface area of several hundred m²/gram) gives it a water retention capacity noticeably higher than ordinary soil, which can reduce surface runoff and favor infiltration toward groundwater tables.
- **Fire stability:** already pyrolyzed, biochar is chemically stable and does not act as fuel under normal fire-spread conditions. Incorporated into forest soils in at-risk areas, it can reduce the amount of combustible organic matter available at the surface.
- **Biological support:** its porosity makes it a favorable habitat for soil microorganisms (the rhizosphere), which explains its use as a soil amendment in regenerative agriculture.
